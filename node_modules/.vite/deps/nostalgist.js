...
// node_modules/nostalgist/dist/nostalgist.js
var systemCoreMap = {
  gb: "mgba",
  gba: "mgba",
  gbc: "mgba",
...
var ini$2 = getDefaultExportFromCjs(iniExports);
var pathBrowserify;
...
var path$5 = getDefaultExportFromCjs(pathBrowserifyExports);
var vendors = {
  ini: ini$2,
  path: path$5
};
var { path: path$4 } = vendors;
var fileNameHeaderRegex = /filename[^;=\n]*=((['"]).*?\2|[^;\n]*)/;
var urlSegmentSeparator = /[?/#]/;
...
var ResolvableFile = class _ResolvableFile {
  ...
  static async create(rawOrOption) {
    ...
    if (rawOrOption instanceof _ResolvableFile) {
      return rawOrOption;
    }
    const option = typeof rawOrOption === "object" && "raw" in rawOrOption ? rawOrOption : { raw: rawOrOption };
    const resolvableFile = new _ResolvableFile(option);
...
var cdnBaseUrl = "https://cdn.jsdelivr.net/gh";
var coreRepo = "arianrhodsandlot/retroarch-emscripten-build";
var coreVersion = "v1.21.0";
var coreDirectory = "retroarch";
var shaderRepo = "libretro/glsl-shaders";
var shaderVersion = "f3dc75a";
...
var globalOptions = getDefaultOptions();
...
var _EmulatorOptions = class _EmulatorOptions {
  constructor(options) {
    __publicField(this, "beforeLaunch");
    __publicField(this, "bios", []);
    __publicField(this, "cache", { bios: false, core: false, rom: false, shader: false, sram: false, state: false });
...
var EmulatorOptions = _EmulatorOptions;
var coreInfoMap = {
...
var { ini: ini$1, path: path$1 } = vendors;
var userdataDirectory = "/home/web_user/retroarch/userdata";
var bundleDirectory = "/home/web_user/retroarch/bundle";
var contentDirectory = path$1.join(userdataDirectory, "content");
var systemDirectory = path$1.join(userdataDirectory, "system");
var configDirectory = path$1.join(userdataDirectory, "config");
var screenshotsDirectory = path$1.join(userdataDirectory, "screenshots");
var shaderDirectory = path$1.join(bundleDirectory, "shaders", "shaders_glsl");
var shaderAssetsDirectory = path$1.join(shaderDirectory, "shaders");
var configPath = path$1.join(userdataDirectory, "retroarch.cfg");
var coreConfigPath = path$1.join(userdataDirectory, "retroarch-core-options.cfg");
var _EmulatorFileSystem = class _EmulatorFileSystem {
  constructor({
    emscriptenModule,
    signal
  }) {
...
var EmulatorFileSystem = _EmulatorFileSystem;
var { ini, path } = vendors;
var Emulator = class {
  constructor(options) {
...
var _Nostalgist = class _Nostalgist {
  constructor(options) {
...
var Nostalgist = _Nostalgist;
export {
  Nostalgist
};
//# sourceMappingURL=nostalgist.js.map
